...
## !!! Webcam udev rules Setting !!!
calibration info modify -> camera_info.yaml
```shell
# modify 98-camera-name-setting.rules file
# (Microsoft Corp. LifeCam HD-3000's rules file)
# set your webcam's vendor / product id
