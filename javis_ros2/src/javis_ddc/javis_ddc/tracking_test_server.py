...
from javis_interfaces.action import TrackingTest
...
class TrackingTestServer(Node):
    def __init__(self):
        super().__init__('tracking_test_server')
        ...
        self.dobby_nav2_server = ActionServer(self, TrackingTest, 'tracking_test',
    ...
    def amcl_callback(self, msg):
        self.amcl_pose = msg
    def goal_callback(self, goal_request: TrackingTest.Goal):
    ...
    async def execute_callback(self, goal_handle):
        ...
        feedback_msg = TrackingTest.Feedback()
        result = TrackingTest.Result()
        self.goal_sent = True
